...
function SearchScreen({ auth, permissions }: { auth: SearchAuth; permissions: string[] }) {
  ...
  return <main className="v12-roles"><header><a href="/">Back to WorkshopOS</a><h1>Global record search</h1><p>Results contain only records allowed by your current tenant, branch, and action permissions.</p></header>
